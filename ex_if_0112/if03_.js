...
var ddi = rs.question("Informe o DDI: ")

if(ddi == 1){
    console.log("DDI correspondente ao Estados Unidos")
}else if(ddi == 49){
    console.log("DDI correspondente ao Alemanha")
}else if(ddi == 54){
    console.log("DDI correspondente ao Argentina")
}else if(ddi == 55){
    console.log("DDI correspondente ao Brasil")
}else if(ddi == 35){
    console.log("DDI correspondente ao Portugal")
}
else{
